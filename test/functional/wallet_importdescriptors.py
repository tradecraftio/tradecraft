...
class ImportDescriptorsTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(change_addr, 'fcrt1qrk995famq96k2m32gz2lh4cv2mh4n4r8dj4w78kc5qel00zer9uqcjqgdn')
        ...
        assert_equal(change_addr, 'fcrt1q8ypfwq37snawnzs7au4k3cu6efceyuengh6w02ek5fjntlzh22uqzyq8yj')
