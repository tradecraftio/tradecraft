    ...
    def run_test(self):
        ...
        for node in self.nodes[:2]:
            with node.assert_debug_log(['limited pruning to height 689']):
                ...
                assert_equal(pruneheight_new, 236)
        ...
        self.generate(self.nodes[0], 894 - 700)
        self.sync_index(height=894)
