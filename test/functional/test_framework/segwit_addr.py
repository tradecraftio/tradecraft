...
class TestFrameworkScript(unittest.TestCase):
    def test_segwit_encode_decode(self):
        ...
        # P2WPK
        test_python_bech32('fcrt1qthmht0k2qnh3wy7336z05lu2km7emzfpg980hv')
        # P2WSH
        test_python_bech32('fcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq0nr988')
        test_python_bech32('fcrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqwvzyyp')
        # P2TR
