...
DUPLICATE_COINBASE_SCRIPT_SIG = b'\x01\x79'  # Valid for block at height 121
...
class FullBlockTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        blocks = []
        for i in range(NUM_BUFFER_BLOCKS_TO_GENERATE + 1):
        ...
        assert_equal(self.nodes[0].gettxout(txid=duplicate_tx.hash, n=0), None)
