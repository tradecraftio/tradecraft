...
class DescriptorTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, 'A function is needed within P2SH', self.test_desc, 'sh(wpk(03fff97bd5755eeea420453a14355235d382f6472f8568a18b2f057a1460297556))', isrange=False, issolvable=True, hasprivatekeys=False)
        ...
        assert_raises_rpc_error(-5, 'A function is needed within P2SH', self.test_desc, 'sh(wsh(pkh(02e493dbf1c10d80f3581e4904930b1404cc6c13900ee0758474fa94abe8c4cd13)))', isrange=False, issolvable=True, hasprivatekeys=False)
