...
class NotificationsTest(FreicoinTestFramework):
    ...
    def run_test(self):
        if self.is_wallet_compiled():
            ...
            desc_imports = [{
                "desc": descsum_create("wpk(" + xpriv + "/0/*)"),
                "timestamp": 0,
                "active": True,
                "keypool": True,
            },{
                "desc": descsum_create("wpk(" + xpriv + "/1/*)"),
                "timestamp": 0,
                "active": True,
                "keypool": True,
                "internal": True,
        ...
        if self.is_wallet_compiled():
            ...
            blockhash1 = self.nodes[0].generatetoaddress(1, ADDRESS_FCRT1_UNSPENDABLE)[0]
            ...
            blockhash2 = self.nodes[0].generatetoaddress(1, ADDRESS_FCRT1_UNSPENDABLE)[0]
