...
class WalletTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            # Taproot addresses cannot are imported into a legacy wallet as unknown witness versions
        ...
        expected_receive_vout = {"label":    "baz",
                                 ...
                                 "vout":     baz["vout"]}
        expected_fields = frozenset({'amount', 'refheight', 'confirmations', 'details', 'fee', 'demurrage',
