...
from test_framework.blocktools import create_block, NORMAL_GBT_REQUEST_PARAMS, create_coinbase, get_final_tx_info, add_final_tx, add_witness_commitment
...
class BIP68Test(FreicoinTestFramework):
    ...
    def test_disable_flag(self):
        ...
        tx1 = CTransaction()
        value = int(kria_round(utxo["value"] - self.relayfee)*COIN)
