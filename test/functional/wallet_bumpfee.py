...
def test_watchonly_pst(self, peer_node, rbf_node, dest_address):
    ...
    pst = watcher.walletcreatefundedpst([], {dest_address: 0.0005}, 0, -1, {"fee_rate": 1}, True)['pst']
...
def spend_one_input(node, dest_address, change_size=Decimal("0.00049000")):
    tx_input = dict(
        sequence=MAX_SEQUENCE_NONFINAL, **next(u for u in node.listunspent() if u["amount"] == Decimal("0.00100000")))
