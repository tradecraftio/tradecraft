...
BASE_SCRIPTS = [
    ...
    'wallet_watchonly.py --bitcoin-mode',
    'wallet_watchonly.py --usecli --bitcoin-mode',
    'wallet_reorgsrestore.py --bitcoin-mode',
    'interface_http.py',
    'interface_rpc.py',
    'rpc_pst.py --bitcoin-mode',
    'rpc_users.py',
    'feature_proxy.py',
    ...
    'wallet_importprunedfunds.py --bitcoin-mode',
    'p2p_leak_tx.py',
    'rpc_signmessage.py',
    ...
    'wallet_listsinceblock.py --bitcoin-mode',
    'p2p_leak.py',
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, runs_ci, use_term_control):
    ...
    # pidof might fail or return an empty string if freicoind is not running
    try:
        if subprocess.check_output(["pidof", "freicoind"]) not in [b'']:
