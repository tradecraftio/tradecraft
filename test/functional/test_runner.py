...
BASE_SCRIPTS = [
    ...
    'rpc_fundrawtransaction.py --legacy-wallet --bitcoin-mode',
    'rpc_fundrawtransaction.py --descriptors --bitcoin-mode',
    'p2p_compactblocks.py --bitcoin-mode',
    'p2p_compactblocks_blocksonly.py',
    'feature_segwit.py --legacy-wallet --bitcoin-mode',
    'feature_segwit.py --descriptors --bitcoin-mode',
    ...
    #'wallet_address_types.py --legacy-wallet --bitcoin-mode', # Disabled by removal of p2sh-legacy
    #'wallet_address_types.py --descriptors --bitcoin-mode', # Disabled by removal of p2sh-legacy
    ...
    'rpc_signrawtransaction.py --legacy-wallet --bitcoin-mode',
    'rpc_signrawtransaction.py --descriptors --bitcoin-mode',
    ...
    'wallet_multisig_descriptor_pst.py --bitcoin-mode',
    ...
    'feature_rbf.py --legacy-wallet --bitcoin-mode',
    'feature_rbf.py --descriptors --bitcoin-mode',
    'mempool_packages.py --bitcoin-mode',
    'mempool_package_onemore.py --bitcoin-mode',
    'rpc_createmultisig.py --legacy-wallet --bitcoin-mode',
    'rpc_createmultisig.py --descriptors --bitcoin-mode',
    ...
    'feature_logging.py',
    'feature_anchors.py',
    'feature_coinstatsindex.py --legacy-wallet --bitcoin-mode',
    'feature_coinstatsindex.py --descriptors --bitcoin-mode',
