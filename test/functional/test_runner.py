...
BASE_SCRIPTS = [
    ...
    'interface_freicoin_cli.py --legacy-wallet',
    'interface_freicoin_cli.py --descriptors',
    ...
    'interface_http.py',
    'interface_rpc.py',
    'rpc_pst.py --legacy-wallet',
    'rpc_pst.py --descriptors',
    'rpc_users.py',
    'rpc_whitelist.py',
    'feature_proxy.py',
    ...
    'wallet_multisig_descriptor_pst.py',
