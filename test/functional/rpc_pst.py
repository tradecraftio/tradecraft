...
class PSTTest(FreicoinTestFramework):
    ...
    def test_utxo_conversion(self):
        ...
        signed_pst = offline_node.walletprocesspst(pst_new.hex())["pst"]
        assert not "non_witness_utxo" in mining_node.decodepst(signed_pst)["inputs"][0]
    ...
    def test_input_confs_control(self):
        ...
        signed_tx1 = wallet.walletprocesspst(pstx1)['pst']
        final_tx1 = wallet.finalizepst(signed_tx1)['hex']
        ...
        signed_invalid = wallet.walletprocesspst(pst_invalid)['pst']
        final_invalid = wallet.finalizepst(signed_invalid)['hex']
        ...
        signed_tx2 = wallet.walletprocesspst(pstx2)['pst']
        final_tx2 = wallet.finalizepst(signed_tx2)['hex']
    ...
    def run_test(self):
        ...
        decoded = self.nodes[1].decodepst(updated)
        test_pst_input_keys(decoded['inputs'][0], ['witness_utxo', 'bip32_derivs', 'witness_path', 'witness_branch', 'witscript_version', 'witness_script'])
        test_pst_input_keys(decoded['inputs'][1], [])
        test_pst_input_keys(decoded['inputs'][2], ['witness_utxo', 'bip32_derivs', 'witness_path', 'witness_branch', 'witscript_version', 'witness_script', 'redeem_script'])
