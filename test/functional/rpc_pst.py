...
class PSTTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].walletcreatefundedpst([], [{self.nodes[2].getnewaddress():unspent["amount"]+1}], block_height+2, unspent["refheight"], {"changeAddress":self.nodes[1].getnewaddress()}, False)
