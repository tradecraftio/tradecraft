...
class PSTTest(FreicoinTestFramework):
    ...
    def test_pst_incomplete_after_invalid_modification(self):
        ...
        signed_pst_obj = PST.from_base64(signed_pst)
        ...
        signed_pst_incomplete = wallet.walletprocesspst(signed_pst_obj.to_base64(), finalize=False)
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-22, "TX decode failed", self.nodes[0].analyzepst, "")

        assert_raises_rpc_error(-22, "TX decode failed", self.nodes[0].walletprocesspst, "")
        ...
        if self.options.descriptors:
            ...
            parsed_pst = PST.from_base64(pst)
            ...
            comb_pst = self.nodes[0].combinepst([pst, parsed_pst.to_base64()])
        ...
        pst.o = [PSTMap()]
        res_inputs = self.nodes[0].decodepst(pst.to_base64())["inputs"]
        ...
        tx.vin = [CTxIn(outpoint=COutPoint(hash=int('aa' * 32, 16), n=0), scriptSig=b"")]
        tx.vout = [CTxOut(nValue=0, scriptPubKey=b"")]
        pst1 = PST(g=PSTMap({PST_GLOBAL_UNSIGNED_TX: tx.serialize()}), i=[PSTMap()], o=[PSTMap()]).to_base64()
        tx.vout[0].nValue += 1  # slightly modify tx
        pst2 = PST(g=PSTMap({PST_GLOBAL_UNSIGNED_TX: tx.serialize()}), i=[PSTMap()], o=[PSTMap()]).to_base64()
        ...
        pst.o = [PSTMap()]
        assert_equal(self.nodes[0].finalizepst(pst.to_base64()),
