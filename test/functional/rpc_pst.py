...
class PSTTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        pstx = wmulti.walletcreatefundedpst(inputs=[{"txid":txid,"vout":p2wsh_pos},{"txid":txid,"vout":p2sh_pos}], outputs={self.nodes[1].getnewaddress():19.99}, lockheight=refheight, changeAddress=self.nodes[1].getrawchangeaddress())['pst']
        ...
        pst = self.nodes[1].createpst([utxo1, utxo2], {self.nodes[0].getnewaddress():32.999})
        ...
        self.generate(self.nodes[0], 6)[0]
        pst = self.nodes[1].createpst([utxo], {self.nodes[0].getnewaddress("", "bech32"):Decimal('6.999')})
