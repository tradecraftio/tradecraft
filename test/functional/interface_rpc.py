...
class RPCInterfaceTest(FreicoinTestFramework):
    ...
    def test_http_status_codes(self):
        ...
        expect_http_rpc_status(204, None,                   self.nodes[0], "generatetoaddress", [1, "fcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq7z4ddu"],  2, True)
