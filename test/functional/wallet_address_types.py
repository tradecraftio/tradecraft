...
class AddressTypeTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Nodes with addresstype=legacy never use a P2WPK change output")
        self.test_change_output_type(0, [to_address_bech32_1], 'legacy')

        self.log.info("Nodes with addresstype=p2sh-segwit only use a P2WPK change output if any destination address is bech32:")
        ...
        self.log.info("Nodes with addresstype=bech32 always use a P2WPK change output (unless changetype is set otherwise):")
