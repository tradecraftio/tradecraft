...
VB_UNKNOWN_BIT = 12       # Choose a bit unassigned to any deployment and
                          # outside the BIP320 version-rolling range (13-28),
                          # which is exempt from unknown-rules warnings
