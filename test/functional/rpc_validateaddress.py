...
INVALID_DATA = [
    ...
    (
        ...
        "All address types in Freicoin use Bech32m checksum.",
        [],
    ),
    (
        "fc1rw5v5eqgn",
        "All address types in Freicoin use Bech32m checksum.",  # Invalid program length
        [],
    ),
    (
    ...
    (
        ...
        "All address types in Freicoin use Bech32m checksum.",  # Invalid checksum (Bech32 instead of Bech32m)
        [],
    ),
    (
