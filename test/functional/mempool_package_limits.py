...
class MempoolPackageLimitsTest(FreicoinTestFramework):
    ...
    def test_desc_count_limits(self):
        ...
        tx_child_b.wit.vtxinwit[0].scriptWitness.stack = [b'\x00' + CScript([OP_TRUE]), b'']
    ...
    def test_desc_count_limits_2(self):
        ...
        tx_child_p1.wit.vtxinwit[0].scriptWitness.stack = [b'\x00' + CScript([OP_TRUE]), b'']
