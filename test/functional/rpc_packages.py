...
class RPCPackagesTest(FreicoinTestFramework):
    ...
    def test_multiple_children(self):
        ...
        # Child A
        (_, tx_child_a_hex, _, _) = make_chain(node, self.address, self.privkeys, parent_txid, child_value, child_refheight, 0, parent_locking_script_a)
    ...
    def test_conflicting(self):
        ...
        rawtx2 = node.createrawtransaction(inputs, output2, 0, prevtx["refheight"])
    ...
    def test_rbf(self):
        ...
        raw_replaceable_tx = node.createrawtransaction(inputs, output, 0, coin["refheight"])
