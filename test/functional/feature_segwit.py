...
class SegWitTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        send_to_witness(1, self.nodes[2], getutxo(wit_ids[NODE_2][P2WPK][0]), self.pubkey[0], encode_p2sh=False, amount=Decimal("49.998"), sign=True)
        ...
        send_to_witness(1, self.nodes[2], getutxo(p2sh_ids[NODE_2][P2WPK][0]), self.pubkey[0], encode_p2sh=False, amount=Decimal("49.998"), sign=True)
        ...
        self.fail_accept(self.nodes[0], "mandatory-script-verify-flag-failed (Witness program was passed an empty witness)", p2sh_ids[NODE_0][P2WPK][0], sign=False, redeem_script=witness_script(False, self.pubkey[0]))
        ...
        self.fail_accept(self.nodes[2], 'mandatory-script-verify-flag-failed (Witness program was passed an empty witness)', p2sh_ids[NODE_2][P2WPK][2], sign=False, redeem_script=witness_script(False, self.pubkey[2]))
        ...
        self.success_mine(self.nodes[0], p2sh_ids[NODE_0][P2WPK][0], True)
        ...
        if not self.options.descriptors:
            ...
            for i in compressed_solvable_address:
                ...
                if v['isscript']:
                    ...
                    solvable_anytime.extend([bare, p2wsh_long, p2wsh_short, p2sh_p2wsh_short, p2pkh])
                    solvable_after_importaddress.extend([p2sh, p2sh_p2pkh, p2sh_p2wsh_long])
                    # Non-standard scripts won't be recognized
                    unseen_anytime.extend([p2wsh_long_p2pkh, p2sh_p2wsh_long_p2pkh, p2wsh_short_p2pkh, p2sh_p2wsh_short_p2pkh])
            ...
            for i in compressed_spendable_address:
                ...
                if v['isscript']:
                    ...
                    spendable_anytime.extend([bare, p2wsh_long, p2wsh_short, p2sh_p2wsh_short, p2pkh])
                    spendable_after_importaddress.extend([p2sh_p2wsh_long])
