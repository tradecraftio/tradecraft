...
class SegWitTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.generate(self.nodes[2], 1)  # block 426
        self.generate(self.nodes[2], 1)  # block 427
        ...
        self.generate(self.nodes[0], 1)  # block 434
        self.generate(self.nodes[0], 1)  # block 435
