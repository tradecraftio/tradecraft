...
class ImportMultiTest(FreicoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["bcrt1qqled64ja2uzm22tuljxgrkt6wxarefplunk52t", "bcrt1qwc7hkenmn2zrjx7zgcna7k5cfwwlgx32czdzsj"] # wpkh subscripts corresponding to the above addresses
