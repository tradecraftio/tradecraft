...
def initialize_chain(test_dir, num_nodes, bitcoinmode=False):
    """
    ...
    if create_cache:
        ...
        for i in range(MAX_NODES):
            datadir=initialize_datadir("cache", i, bitcoinmode=bitcoinmode)
...
def stop_node(node, i):
    ...
    freicoind_processes[i].wait(timeout=FREICOIND_PROC_WAIT_TIMEOUT)
...
def wait_freicoinds():
    ...
    for freicoind in freicoind_processes.values():
        freicoind.wait(timeout=FREICOIND_PROC_WAIT_TIMEOUT)
