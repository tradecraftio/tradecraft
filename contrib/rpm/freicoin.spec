...
#man pages
Source20:	https://raw.githubusercontent.com/freicoin/freicoin/v%{version}/contrib/debian/manpages/freicoind.1
Source21:	https://raw.githubusercontent.com/freicoin/freicoin/v%{version}/contrib/debian/manpages/freicoin-cli.1
Source22:	https://raw.githubusercontent.com/freicoin/freicoin/v%{version}/contrib/debian/manpages/freicoin-qt.1
Source23:	https://raw.githubusercontent.com/freicoin/freicoin/v%{version}/contrib/debian/manpages/freicoin.conf.5
...
%endif
install -D -p %{SOURCE23} %{buildroot}%{_mandir}/man5/freicoin.conf.5
...
%attr(0644,root,root) %{_mandir}/man5/freicoin.conf.5*
...
# based upon the 0.11.2 package spec file from https://www.ringingliberty.com/freicoin/
