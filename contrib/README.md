...
Contains files used to package freicoind/freicoin-qt
for Debian-based Linux systems. If you compile freicoind/freicoin-qt yourself, there are some useful files here.

### [Gitian-descriptors](/contrib/gitian-descriptors) ###
Files used during the gitian build process. For more information about gitian, see the [the Freicoin documentation repository](https://github.com/freicoin/docs).

### [Gitian-keys](/contrib/gitian-keys)
PGP keys used for signing Freicoin [Gitian release](/doc/release-process.md) results.
