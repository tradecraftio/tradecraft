...
bech32_templates = [
  ...
  ('fc',    0, 20, (False, 'main',    None, True), Encoding.BECH32M, p2wpkh_prefix),
  ...
  ('tf',    0, 20, (False, 'test',    None, True), Encoding.BECH32M, p2wpkh_prefix),
  ...
  ('fcrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32M, p2wpkh_prefix),
