...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FREICOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define FREICOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the freicoin network\n')
    ...
    g.write('#endif // FREICOIN_CHAINPARAMSSEEDS_H\n')
