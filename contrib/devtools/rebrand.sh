...
if [ -e src/secp256k1/src/java/org/bitcoin ]; then
  ...
  git mv src/secp256k1/src/java/org_bitcoin_Secp256k1Context.c src/secp256k1/src/java/in_freico_Secp256k1Context.c
  git mv src/secp256k1/src/java/org_bitcoin_Secp256k1Context.h src/secp256k1/src/java/in_freico_Secp256k1Context.h
  git mv src/secp256k1/src/java/org src/secp256k1/src/java/in
  git mv src/secp256k1/src/java/in/bitcoin src/secp256k1/src/java/in/freico
...
# The IRC channel doesn't have the '-dev' suffix
...
git grep -z -l 'travis-ci\.org/freicoin/freicoin' | xargs -0 sed -i 's:travis-ci\.org/freicoin/freicoin:travis-ci.org/tradecraftio/tradecraft:g'
git grep -z -l 'travis-ci\.org/freicoin/secp256k1' | xargs -0 sed -i 's:travis-ci\.org/freicoin/secp256k1:travis-ci.org/bitcoin-core/secp256k1:g'
git grep -z -l 'ringingliberty\.com/freicoin' | xargs -0 sed -i 's:ringingliberty\.com/freicoin:ringingliberty.com/bitcoin:g'
