...
As of Freicoin v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/freicoin/guix.sigs/). When
...
builder-keys](https://github.com/freicoin/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from http://freico.in and http://freico.in.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/freicoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/freicoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
