# Bootstrappable Freicoin Builds

This directory contains the files necessary to perform bootstrappable Freicoin
Core builds.
...
- 24GB of free disk space on the partition that the Freicoin git repository
  resides in
...
For a Freicoin depends development environment, simply invoke
...
From the top of a clean Freicoin repository:
...
To use dongcarl's substitute server for Freicoin builds after having
