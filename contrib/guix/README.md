...
To build Freicoin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/freicoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/freicoin/guix.sigs).
