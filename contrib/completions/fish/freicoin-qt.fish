...
complete --command freicoin-qt --no-files

# Extract options
function __fish_freicoinqt_get_options
...
complete \
    --command freicoin-qt \
    --arguments "(__fish_freicoinqt_get_options --nofiles)"
