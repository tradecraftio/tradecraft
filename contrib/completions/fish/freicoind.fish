...
complete --command freicoind --no-files

# Extract options
function __fish_freicoind_get_options
...
complete \
    --command freicoind \
    --arguments "(__fish_freicoind_get_options --nofiles)"
