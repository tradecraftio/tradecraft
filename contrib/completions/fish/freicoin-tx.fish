...
# Extract options
function __fish_freicoin_tx_get_options
...
# Extract commands
function __fish_freicoin_tx_get_commands
...
complete \
    --command freicoin-tx \
    --condition "not __fish_freicoin_seen_cmd (__fish_freicoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_freicoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command freicoin-tx \
    --arguments "(__fish_freicoin_tx_get_commands)" \
    --no-files
