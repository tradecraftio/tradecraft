...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Freicoin may be
...
The first time you run freicoind, it will start downloading the blockchain. This process could
