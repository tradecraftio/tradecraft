...
2.  Build freicoin:
    This will configure and build the headless freicoin binaries as well as the gui (if Qt is found).
...
If you are building `freicoind` or `Freicoin` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Freicoin
