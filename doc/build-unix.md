...
Otherwise, you can build Freicoin from self-compiled [depends](/depends/README.md).
...
`--with-incompatible-bdb` according to the [PKGBUILD](https://github.com/archlinux/svntogit-community/blob/packages/freicoin/trunk/PKGBUILD).
