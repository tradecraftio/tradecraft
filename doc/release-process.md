...
- Ensure the "Needs release note" label is removed from all relevant pull
  requests and issues:
  https://github.com/tradecraftio/tradecraft/issues?q=label%3A%22Needs+release+note%22
...
To tag the version (or release candidate) in git, use the `make-tag.py` script from [freicoin-maintainer-tools](https://github.com/tradecraftio/tradecraft-maintainer-tools). From the root of the repository run:
    ...
    ../freicoin-maintainer-tools/make-tag.py v(new version, e.g. 25)
...
Then open a Pull Request to the [guix.sigs repository](https://github.com/freicoin/guix.sigs).
...
- Update other repositories and websites for new version
  ...
  - freico.in RPC documentation update
      ...
      - See https://github.com/freicoin/freico.in/blob/master/contrib/doc-gen/

  - Update packaging repo

      - Push the flatpak to flathub, e.g. https://github.com/flathub/in.freicocore.freicoin-qt/pull/2

      - Push the snap, see https://github.com/freicoin/packaging/blob/main/snap/local/build.md
