...
and is the platform used to build the Freicoin Windows release binaries.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/tradecraftio/tradecraft.git
    sudo chmod -R a+rw freicoin
...
It's not possible to build the freicoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the freicoin source code).
