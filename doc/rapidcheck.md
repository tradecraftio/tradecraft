# RapidCheck property-based testing for Freicoin

## Concept

Property-based testing is experimentally being added to Freicoin with
...
If RapidCheck is installed, Freicoin will automatically run the
...
3. Configure Freicoin with RapidCheck.

    `cd` to the directory of your local freicoin repository and run
...
4. Build Freicoin with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_freicoin-crypto_gen.o
    CXX      test/test_freicoin-key_properties.o
    ```
...
That's it! You are now running property-based tests in Freicoin.
