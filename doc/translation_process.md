...
See the [Transifex Freicoin project](https://www.transifex.com/tradecraft/freicoin-1/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
You can find the Freicoin translation project at [https://www.transifex.com/tradecraft/freicoin-1/](https://www.transifex.com/tradecraft/freicoin-1/).
...
To assist in updating translations, a helper script is available in the [maintainer-tools repo](https://github.com/tradecraftio/tradecraft-maintainer-tools). To use it and commit the result, simply do:

```
python3 ../freicoin-maintainer-tools/update-translations.py
git commit -a
```
