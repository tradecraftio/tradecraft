...
These are the dependencies currently used by Freicoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| FreeType | [2.11.0](https://download.savannah.gnu.org/releases/freetype) |  | No |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) (Android only) |
| GCC |  | [8.1](https://gcc.gnu.org/) (C++17 & std::filesystem support) |  |  |  |
| glibc | | [2.18](https://www.gnu.org/software/libc/) |  |  |  |  |
| HarfBuzz-NG |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) |
...
| libpng |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) |
| MiniUPnPc | [2.2.2](https://miniupnp.tuxfamily.org/files) |  | No |  |  |
| PCRE |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) |
...
| XCB |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) (Linux only) |
| systemtap ([tracing](tracing.md))| [4.5](https://sourceware.org/systemtap/ftp/releases/) |  |  |  | |
| xkbcommon |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) (Linux only) |
| ZeroMQ | [4.3.1](https://github.com/zeromq/libzmq/releases) | 4.0.0 | No |  |  |
| zlib |  |  |  |  | [Yes](https://github.com/tradecraftio/tradecraft/blob/master/depends/packages/qt.mk) |
