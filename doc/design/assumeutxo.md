...
**Failure consideration:** if freicoind unexpectedly halts after `m_stop_use` is set on
...
When freicoind initializes again, what began as the snapshot chainstate is now
