...
Clone the git repositories for freicoin and Gitian and then checkout the freicoin version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the freicoin repository
...
Gitian builds' in [doc/release-process.md](release-process.md) in the freicoin repository.
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/freicoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/freicoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/freicoin-build.assert
```
