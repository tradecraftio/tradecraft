...
in the freicoin repository under 'Fetch and create inputs' to install sources which require
...
Output from `gbuild` will look something like
    ...
    From https://github.com/tradecraftio/tradecraft
...
FRCPATH=/some/root/path/freicoin
SIGPATH=/some/root/path/freicoin-detached-sigs
