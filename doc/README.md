...
* Ask for help on [#freicoin](https://web.libera.chat?channels=freicoin) on Libera. If you don't have an IRC client, use [webchat here](https://web.libera.chat?channels=freicoin).
...
### Resources
* Discuss project-specific development on #freicoin on Libera. If you don't have an IRC client, use [webchat here](https://web.libera.chat/?channels=freicoin).
* Discuss general Freicoin development on #freicoin-dev on Libera. If you don't have an IRC client, use [webchat here](https://web.libera.chat/?channels=freicoin-dev).
