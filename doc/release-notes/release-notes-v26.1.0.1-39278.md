v26.1.0.1-39278 Release Notes
=============================

Bitcoin Core version v26.1.0.1-39278 is now available from:

  https://github.com/tradecraftio/mergemine/releases/tag/v26.1.0.1-39278
...
There have been no notable changes in the stratum mining server or the Tradecraft/Freicoin merge-mining patches between v26.0.0.2-39255 and this release.  Please see the Bitcoin Core release notes for notable changes between the upstream versions upon which these releases are based.
