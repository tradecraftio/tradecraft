v24.2.0.1-35627 Release Notes
=============================

Bitcoin Core version v24.2.0.1-35627 is now available from:

  https://github.com/tradecraftio/mergemine/releases/tag/v24.2.0.1-35627
...
There have been upstream changes between v24.1.0.1-35601 and this release.  Please see the Bitcoin Core release notes for notable changes between the upstream versions upon which these releases are based.

There have been no notable changes in the stratum mining server or the Tradecraft/Freicoin merge-mining patches between v24.1.0.1-35601 and this release.
