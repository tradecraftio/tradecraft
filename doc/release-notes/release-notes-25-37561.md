...
- The "Mask values" is a persistent option now.  (bitcoin-core/gui#701)

- The "Mask values" option affects the "Transaction" view now, in addition to the "Overview" one.  (bitcoin-core/gui#708)
