 ...
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0LongHash, WitnessV0ShortHash, WitnessV1Taproot, PayToAnchor, WitnessUnknown>;
