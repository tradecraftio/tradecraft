...
BOOST_AUTO_TEST_CASE(cnode_simple_test)
{
    ...
    std::unique_ptr<CNode> pnode1 = std::make_unique<CNode>(
        id++, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, hSocket, addr,
        /* nKeyedNetGroupIn = */ 0,
        /* nLocalHostNonceIn = */ 0,
...
BOOST_AUTO_TEST_CASE(ipv4_peer_with_ipv6_addrMe_test)
{
    ...
    std::unique_ptr<CNode> pnode = std::make_unique<CNode>(0, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, INVALID_SOCKET, addr, /* nKeyedNetGroupIn */ 0, /* nLocalHostNonceIn */ 0, CAddress{}, /* pszDest */ std::string{}, ConnectionType::OUTBOUND_FULL_RELAY, /* inbound_onion */ false);
