...
BOOST_AUTO_TEST_CASE(test_assumeutxo)
{
    ...
    BOOST_CHECK_EQUAL(out110.hash_serialized.ToString(), "aa46cd10504dd7b9174be6414bbce34633b1633c89ea112519490ff8187739c1");
    BOOST_CHECK_EQUAL(out110.nChainTx, 121U);

    const auto out110_2 = *params->AssumeutxoForBlockhash(uint256S("0x2c796205d46211b5f4158a070bb1e0eba184760eca0c0c42588afb6c8f32b940"));
    BOOST_CHECK_EQUAL(out110_2.hash_serialized.ToString(), "aa46cd10504dd7b9174be6414bbce34633b1633c89ea112519490ff8187739c1");
...
BOOST_AUTO_TEST_CASE(block_malleation)
{
...

    {
        ...
        block.vtx.clear();
        {
            ...
            assert(GetSerializeSize(block.vtx.back(), SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS) == 64);
        }
        BOOST_CHECK(is_not_mutated(block, /*check_witness_root=*/false));
    }

    {
        ...
        BOOST_CHECK(DecodeHexTx(tx3, "ac965eca000172a1ea27d71cec1d2999d2b8cb7b590110d2a929ca3d6f79320ae5add5c2b65085bc81f9e83877f5ae54a41d0f9dce57d70f97832b19591d9fa8", /*try_no_witness=*/true, /*try_witness=*/false));
        {
            ...
            assert(GetSerializeSize(tx3, SER_NETWORK, PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS) == 64);
        }
