...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    BOOST_CHECK_EQUAL(addr_ret1.ToString(), "250.1.1.1:8639");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:8639" || addr_ret2.ToString() == "250.1.1.1:8640");
    ...
    BOOST_CHECK_EQUAL(addr_ret3.ToString(), "250.1.1.1:8639");
}
