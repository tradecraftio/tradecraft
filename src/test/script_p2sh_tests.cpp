...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    BOOST_CHECK(::AreInputsStandard(CTransaction(txToStd3), coins, false));
    ...
    BOOST_CHECK(::AreInputsStandard(CTransaction(txToStd4), coins, false));
    ...
    BOOST_CHECK(!::AreInputsStandard(CTransaction(txToNonStd5), coins, false));
