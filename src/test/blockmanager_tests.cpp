...
BOOST_AUTO_TEST_CASE(blockmanager_find_block_pos)
{
    ...
    BOOST_CHECK_EQUAL(actual.nPos, BLOCK_SERIALIZATION_HEADER_SIZE + ::GetSerializeSize(params->GenesisBlock(), SER_DISK, CLIENT_VERSION) + BLOCK_SERIALIZATION_HEADER_SIZE);
}
