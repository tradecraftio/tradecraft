...
BOOST_AUTO_TEST_CASE(blockmanager_find_block_pos)
{
    ...
    BOOST_CHECK_EQUAL(actual.nPos, BLOCK_SERIALIZATION_HEADER_SIZE + ::GetSerializeSize(BLK_WITH_AUXPOW_AND_WITNESS(params->GenesisBlock())) + BLOCK_SERIALIZATION_HEADER_SIZE);
}
