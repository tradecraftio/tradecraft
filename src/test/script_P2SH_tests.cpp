...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    txToStd3.vin[0].scriptSig << static_cast<vector<unsigned char> >(nineteenSigops);
    ...
    txToStd4.vin[0].scriptSig << static_cast<vector<unsigned char> >(twentyoftwenty);
    ...
    txToNonStd5.vin[0].scriptSig << static_cast<vector<unsigned char> >(twentyoneSigops);
