...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_found)
{
    ...
    // Last txn in block.
    Txid txhash1{TxidFromString("0x231022da320f6263653f030a99e8c397054a968f10811a465f27a1915652ca8f")};
    BOOST_CHECK_EQUAL(txhash1.GetHex(), block.vtx.rbegin()[0]->GetHash().GetHex());

    // Second txn in block.
    Txid txhash2{TxidFromString("0xdb2a16bd92ce546df692e1ff72890cd8fcf9d5d8a0dff6182bab806fdaf9de35")};
