...
{
    BOOST_CHECK_EQUAL(sizeof(char), GetSerializeSize(char(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(int8_t), GetSerializeSize(int8_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(uint8_t), GetSerializeSize(uint8_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(int16_t), GetSerializeSize(int16_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(uint16_t), GetSerializeSize(uint16_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(int32_t), GetSerializeSize(int32_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(uint32_t), GetSerializeSize(uint32_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(int64_t), GetSerializeSize(int64_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(uint64_t), GetSerializeSize(uint64_t(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(float), GetSerializeSize(float(0), SER_NETWORK, 0));
    BOOST_CHECK_EQUAL(sizeof(double), GetSerializeSize(double(0), SER_NETWORK, 0));
    // Bool is serialized as char
    BOOST_CHECK_EQUAL(sizeof(char), GetSerializeSize(bool(0), SER_NETWORK, 0));

    // Sanity-check GetSerializeSize and c++ type matching
    BOOST_CHECK_EQUAL(GetSerializeSize(char(0), SER_NETWORK, 0), 1U);
    BOOST_CHECK_EQUAL(GetSerializeSize(int8_t(0), SER_NETWORK, 0), 1U);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint8_t(0), SER_NETWORK, 0), 1U);
    BOOST_CHECK_EQUAL(GetSerializeSize(int16_t(0), SER_NETWORK, 0), 2U);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint16_t(0), SER_NETWORK, 0), 2U);
    BOOST_CHECK_EQUAL(GetSerializeSize(int32_t(0), SER_NETWORK, 0), 4U);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint32_t(0), SER_NETWORK, 0), 4U);
    BOOST_CHECK_EQUAL(GetSerializeSize(int64_t(0), SER_NETWORK, 0), 8U);
    BOOST_CHECK_EQUAL(GetSerializeSize(uint64_t(0), SER_NETWORK, 0), 8U);
    BOOST_CHECK_EQUAL(GetSerializeSize(float(0), SER_NETWORK, 0), 4U);
    BOOST_CHECK_EQUAL(GetSerializeSize(double(0), SER_NETWORK, 0), 8U);
    BOOST_CHECK_EQUAL(GetSerializeSize(bool(0), SER_NETWORK, 0), 1U);
}
...
BOOST_AUTO_TEST_CASE(varints)
{
    ...
    for (int i = 0; i < 100000; i++) {
        ...
        size += ::GetSerializeSize(VARINT_MODE(i, VarIntMode::NONNEGATIVE_SIGNED), SER_NETWORK, 0);
        BOOST_CHECK(size == ss.size());
    }

    for (uint64_t i = 0;  i < 100000000000ULL; i += 999999937) {
        ss << VARINT(i);
        size += ::GetSerializeSize(VARINT(i), SER_NETWORK, 0);
        BOOST_CHECK(size == ss.size());
    }
