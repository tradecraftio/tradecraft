...
{
    BOOST_CHECK_EQUAL(sizeof(unsigned char), GetSerializeSize((unsigned char)0, SER_NETWORK, 0));
    ...
    BOOST_CHECK_EQUAL(sizeof(uint8_t), GetSerializeSize(bool(0), SER_NETWORK, 0));

    // Sanity-check GetSerializeSize and c++ type matching
    BOOST_CHECK_EQUAL(GetSerializeSize((unsigned char)0, SER_NETWORK, 0), 1U);
