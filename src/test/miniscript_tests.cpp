...
BOOST_AUTO_TEST_CASE(fixed_tests)
{
    ...
    Test("lltvlnt:after(1231488000)", "6300676300676300670400046749b151926869516868", "=", TESTMODE_VALID | TESTMODE_NONMAL, 12, 3, 3, 3, 3);
    ...
    // error is.
    const auto ms_ins = miniscript::FromString("or_i(d:and_v(after(1),after(1000000000)),pk(03cdabb7f2dce7bfbd8a0b9570c6fd1e712e5d64045e9d6b517b3d5072251dc204))", wsh_converter);
