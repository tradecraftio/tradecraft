...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CFreicoinAddress demoAddress = CFreicoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CFreicoinAddress setaccountDemoAddress = CFreicoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
