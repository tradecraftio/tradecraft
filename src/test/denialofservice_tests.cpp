...
BOOST_AUTO_TEST_CASE(outbound_slow_chain_eviction)
{
    ...
    CNode dummyNode1(id++, DEFAULT_MAX_PEER_CONNECTIONS, ServiceFlags(NODE_NETWORK | NODE_WITNESS), INVALID_SOCKET, addr1, /* nKeyedNetGroupIn */ 0, /* nLocalHostNonceIn */ 0, CAddress(), /* pszDest */ "", ConnectionType::OUTBOUND_FULL_RELAY, /* inbound_onion */ false);
...
static void AddRandomOutboundPeer(std::vector<CNode*>& vNodes, PeerManager& peerLogic, ConnmanTestMsg& connman)
{
    ...
    vNodes.emplace_back(new CNode(id++, DEFAULT_MAX_PEER_CONNECTIONS, ServiceFlags(NODE_NETWORK | NODE_WITNESS), INVALID_SOCKET, addr, /* nKeyedNetGroupIn */ 0, /* nLocalHostNonceIn */ 0, CAddress(), /* pszDest */ "", ConnectionType::OUTBOUND_FULL_RELAY, /* inbound_onion */ false));
...
BOOST_AUTO_TEST_CASE(stale_tip_peer_management)
{
    ...
    SetMockTime(GetTime() + 3 * chainparams.GetConsensus().aux_pow_target_spacing + 1);
...
BOOST_AUTO_TEST_CASE(peer_discouragement)
{
    ...
    banman->ClearBanned();
    nodes[0] = new CNode{id++, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, INVALID_SOCKET, addr[0], /* nKeyedNetGroupIn */ 0,
    ...
    nodes[1] = new CNode{id++, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, INVALID_SOCKET, addr[1], /* nKeyedNetGroupIn */ 1,
    ...
    nodes[2] = new CNode{id++, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, INVALID_SOCKET, addr[2], /* nKeyedNetGroupIn */ 1,
                         /* nLocalHostNonceIn */ 1, CAddress(), /* pszDest */ "",
...
BOOST_AUTO_TEST_CASE(DoS_bantime)
{
    ...
    CNode dummyNode(id++, DEFAULT_MAX_PEER_CONNECTIONS, NODE_NETWORK, INVALID_SOCKET, addr, /* nKeyedNetGroupIn */ 4, /* nLocalHostNonceIn */ 4, CAddress(), /* pszDest */ "", ConnectionType::INBOUND, /* inbound_onion */ false);
