...
void CustomizeWork(const ChainstateManager& chainman, const StratumClient& client, const CTxDestination& addr, const uint256& job_id, const StratumWork& current_work, const std::vector<unsigned char>& extranonce2, CMutableTransaction& cb, CMutableTransaction& bf, std::vector<uint256>& cb_branch)
{
...
uint256 CustomizeCommitHash(const ChainstateManager& chainman, const StratumClient& client, const CTxDestination& addr, const uint256& job_id, const StratumWork& current_work, const uint256& secret)
{
