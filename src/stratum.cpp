...
struct StratumClient {
    ...
    StratumClient() : m_socket(0), m_bev(0), m_nextid(0), m_authorized(false), m_mindiff(0.0), m_last_tip(0), m_send_work(false) { GenSecret(); }
    StratumClient(evutil_socket_t socket, bufferevent* bev, CService from) : m_socket(socket), m_bev(bev), m_nextid(0), m_from(from), m_authorized(false), m_mindiff(0.0), m_last_tip(0), m_send_work(false) { GenSecret(); }
