...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/freicoin/bips/blob/master/bip-0013.mediawiki
...
public:
    ...
    virtual bool HaveWitnessV0Script(const uint160& witnessprogram) const;
    virtual bool HaveWitnessV0Script(const uint256& witnessprogram) const;
    virtual bool GetWitnessV0Script(const uint160& witnessprogram, WitnessV0ScriptEntry& entryOut) const;
    virtual bool GetWitnessV0Script(const uint256& witnessprogram, WitnessV0ScriptEntry& entryOut) const;
