...
static void SetupFreicoinTxArgs()
{
    ...
    gArgs.AddArg("lockheight=N", "Set TX lock height to N", ArgsManager::ALLOW_ANY, OptionsCategory::COMMANDS);
    ...
    gArgs.AddArg("outdestroy=VALUE", "Add unspendable output to TX", ArgsManager::ALLOW_ANY, OptionsCategory::COMMANDS);
