...
static WorkQueue<NetEventClosure>* workQueue = nullptr;
...
bool InitEndpointList(const std::string& which, int default_port, std::vector<std::pair<std::string, uint16_t> >& endpoints)
{
    endpoints.clear();
