...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    if ((pindex->pprev->GetMedianTimePast() >= Params().VerifyCoinbaseLockTimeActivationTime()) || ((pindex->nHeight >= Params().VerifyCoinbaseLockTimeMinimumHeight()) && ((block.nVersion >> 28) == 3) && CBlockIndex::IsSuperMajorityBit(28, pindex->pprev))) {
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    if ((pindexPrev->GetMedianTimePast() < Params().VerifyCoinbaseLockTimeActivationTime()) && (nHeight >= Params().VerifyCoinbaseLockTimeMinimumHeight()) && ((block.nVersion >> 28) != 3) && CBlockIndex::IsSuperMajorityBit(28, pindexPrev)) {
