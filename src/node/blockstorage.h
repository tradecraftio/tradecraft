...
private:
    ...
    bool FindBlockPos(FlatFilePos& pos, unsigned int nAddSize, const Consensus::Params& consensus_params, unsigned int nHeight, CChain& active_chain, uint64_t nTime, bool fKnown);
