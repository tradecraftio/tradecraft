 ...
 */
util::Result<CreatedTransactionResult> CreateTransaction(CWallet& wallet, const std::vector<CRecipient>& vecSend, int64_t refheight, int change_pos, const CCoinControl& coin_control, bool sign = true);
