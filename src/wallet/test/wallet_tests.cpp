...
public:
    ...
    CWalletTx& AddTx(CRecipient recipient)
    {
        ...
        {
            BOOST_CHECK(CreateTransaction(*wallet, {recipient}, -1 /* refheight */, tx, fee, changePos, error, dummy, fee_calc_out));
        }
...
BOOST_FIXTURE_TEST_CASE(ListCoinsTest, ListCoinsTestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(GetTimeAdjustedValue(50 * COIN, 101), GetAvailableBalance(*wallet));
    ...
    // Lock both coins. Confirm number of available coins drops to 0.
    {
        ...
        AvailableCoins(*wallet, available, /* atheight= */ 0);
