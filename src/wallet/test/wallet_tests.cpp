...
BOOST_FIXTURE_TEST_CASE(scan_for_wallet_transactions, TestChain100Setup)
{
    ...
    // and new block files.
    {
        ...
        BOOST_CHECK_EQUAL(wallet.GetBalance().m_mine_immature, GetTimeAdjustedValue(50 * COIN, 2) + GetTimeAdjustedValue(50 * COIN, 1));
    }
    ...
    // file.
    {
        ...
        BOOST_CHECK_EQUAL(result.last_scanned_block, newTip->GetBlockHash());
        BOOST_CHECK_EQUAL(*result.last_scanned_height, newTip->nHeight);
        BOOST_CHECK_EQUAL(wallet.GetBalance().m_mine_immature, GetTimeAdjustedValue(50 * COIN, 1));
    }
...
public:
    ...
    CWalletTx& AddTx(CRecipient recipient)
    {
        ...
        {
            BOOST_CHECK(wallet->CreateTransaction({recipient}, -1 /* refheight */, tx, fee, changePos, error, dummy, fee_calc_out));
        }
...
BOOST_FIXTURE_TEST_CASE(ListCoins, ListCoinsTestingSetup)
{
    ...
    // Lock both coins. Confirm number of available coins drops to 0.
    {
        ...
        wallet->AvailableCoins(available, /* height= */ 0, /* fOnlySafe= */ true, /* coinControl= */ nullptr, /* nMinimumAmount= */ 1, /* nMaximumAmount= */ MAX_MONEY, /* nMinimumSumAmount= */ MAX_MONEY, /* nMaximumCount= */ 0);
