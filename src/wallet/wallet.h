 ...
 * change.
 *
 * The Freicoin wallet was originally a collection of unrelated private
...
public:
     ...
     */
    bool CreateTransaction(interfaces::Chain::Lock& locked_chain, const std::vector<CRecipient>& vecSend, int64_t refheight, CTransactionRef& tx, CAmount& nFeeRet, int& nChangePosInOut,
