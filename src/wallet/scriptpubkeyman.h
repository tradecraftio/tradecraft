...
public:
    ...
    virtual TransactionError FillPST(PartiallySignedTransaction& pst, int sighash_type = 1 /* SIGHASH_ALL */, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr) const { return TransactionError::INVALID_PST; }
...
public:
    ...
    TransactionError FillPST(PartiallySignedTransaction& pst, int sighash_type = 1 /* SIGHASH_ALL */, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr) const override;
