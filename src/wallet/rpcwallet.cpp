...
static RPCHelpMan bumpfee_helper(std::string method_name)
{
    ...
    "         \"" + FeeModes("\"\n\"") + "\""},
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "", Cat(Cat<std::vector<RPCResult>>(
            {
                {RPCResult::Type::STR, "pst", "The base64-encoded unsigned PST of the new transaction." + std::string(want_pst ? "" : " Only returned when wallet private keys are disabled. (DEPRECATED)")},
            },
