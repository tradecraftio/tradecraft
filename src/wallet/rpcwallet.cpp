...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    SendMoney(pwallet, dest, nAmount, -1, fSubtractFeeFromAmount, wtx, coin_control);
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    SendMoney(pwallet, dest, nAmount, -1, false, wtx, no_coin_control);
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4) {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" \"address_type\" )\n"
            ...
            "}\n"
            "\nResult (DEPRECATED. To see this result in v16 instead, please start freicoind with -deprecatedrpc=addmultisigaddress).\n"
            "        clients should transition to the new output api before upgrading to v17.\n"
        ...
        RPCTypeCheckObj(options,
            {
                ...
                {"reserveChangeKey", UniValueType(UniValue::VBOOL)}, // DEPRECATED (and ignored), should be removed in v16 or so.
