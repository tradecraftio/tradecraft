...
bool CWallet::FundTransaction(CMutableTransaction& tx, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, bool lockUnspents, const std::set<int>& setSubtractFeeFromOutputs, CCoinControl coinControl)
{
    ...
    if (!CreateTransaction(vecSend, tx.lock_height ? tx.lock_height : -1, tx_new, reservekey, nFeeRet, nChangePosInOut, strFailReason, coinControl, false)) {
        return false;
    }
...
bool CWallet::CreateTransaction(const std::vector<CRecipient>& vecSend, int64_t refheight, CTransactionRef& tx, CReserveKey& reservekey, CAmount& nFeeRet,
    ...
    int nBytes;
    {
        ...
        }
        {
            ...
            if (!boost::get<CNoDestination>(&coin_control.destChange)) {
                ...
                const OutputType change_type = TransactionChangeType(coin_control.m_change_type ? *coin_control.m_change_type : m_default_change_type, vecSend, IsWitnessEnabled(chainActive.Tip(), Params().GetConsensus()));
