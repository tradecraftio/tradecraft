        ...
        [want_pst](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    res = feebumper::CreateRateBumpTransaction(*pwallet, hash, coin_control, errors, old_fee, new_fee, mtx, /*require_mine=*/ !want_pst);
    ...
    return RPCHelpMan{"sendall",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (options.exists("inputs") && options.exists("send_max")) {
                ...
                for (const COutput& output : AvailableCoins(*pwallet, current_height + 1, &coin_control, fee_rate, /*nMinimumAmount=*/0).All()) {
