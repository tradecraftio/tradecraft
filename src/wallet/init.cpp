...
{
    argsman.AddArg("-addresstype", strprintf("What type of addresses to use (\"legacy\", \"bech32\", or \"bech32m\", default: \"%s\")", FormatOutputType(DEFAULT_ADDRESS_TYPE)), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    argsman.AddArg("-changetype",
                   "What type of change to use (\"legacy\", \"bech32\", or \"bech32m\"). Default is \"legacy\" when "
