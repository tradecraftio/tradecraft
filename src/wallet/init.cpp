...
{
    gArgs.AddArg("-addresstype", strprintf("What type of addresses to use (\"legacy\" or \"bech32\", default: \"%s\")", FormatOutputType(DEFAULT_ADDRESS_TYPE)), false, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-changetype", "What type of change to use (\"legacy\" or \"bech32\"), default is same as -addresstype)", false, OptionsCategory::WALLET);
