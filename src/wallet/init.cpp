...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-walletblockfinaltx=<wallet>", "Use the named wallet for constructing block-final transactions using wallet outputs prior to activation of the block-final transaction rules");
    strUsage += HelpMessageOpt("-minesweepto=<address>", "Use the block-final transaction to send all value of the walletblockfinaltx wallet to the specified address in generated block templates");
    strUsage += HelpMessageOpt("-carryforward=<address>", "Create an output to the specified address in the block-final transaction, typically to provide an input to the block-final transaction of the next block (default: use wallet-generated change address)");
