...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-walletblockfinaltx=<wallet>", "Use the named wallet for constructing block-final transactions using wallet outputs prior to activation of the block-final transaction rules", ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
    gArgs.AddArg("-minesweepto=<address>", "Use the block-final transaction to send all value of the walletblockfinaltx wallet to the specified address in generated block templates", ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
    gArgs.AddArg("-carryforward=<address>", "Create an output to the specified address in the block-final transaction, typically to provide an input to the block-final transaction of the next block (default: use wallet-generated change address)", ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
}
