...
bool CMessageHeader::IsValid(const MessageStartChars& pchMessageStartIn, size_t max_untrusted_peers) const
{
    // Check start string
    ...
    // Message size
    if (nMessageSize > MaxProtocolMessageLength(Params().GetConsensus(), max_untrusted_peers))
    {
