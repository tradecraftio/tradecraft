...
#ifndef FREICOIN_RPC_PROTOCOL_H
#define FREICOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in freicoind
