    ...
    return RPCHelpMan{"gettxoutsetinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_AMOUNT, "total_value", "The total amount of coins in the UTXO set, without reference-height adjustments"},
                        {RPCResult::Type::STR_AMOUNT, "total_amount", "The total amount of coins in the UTXO set, adjusted to the next block height"},
                        {RPCResult::Type::STR_AMOUNT, "total_unspendable_value", "The total amount of coins permanently excluded from the UTXO set, without reference-height adjustments (only available if coinstatsindex is used)"},
                        {RPCResult::Type::STR_AMOUNT, "total_unspendable_amount", "The total amount of coins permanently excluded from the UTXO set, adjusted to the next block height (only available if coinstatsindex is used)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (GetUTXOStats(coins_view, *blockman, stats, node.rpc_interruption_point, pindex)) {
        ...
        if (!stats.index_used) {
            ...
            ret.pushKV("total_unspendable_value", ValueFromAmount(stats.block_unspendable_value));
            ...
            block_info.pushKV("unspendable", ValueFromAmount(stats.block_unspendable_value - prev_stats.block_unspendable_value));
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "freicoin address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of freicoin addresses",
                        {{RPCResult::Type::STR, "address", "freicoin address"}}},
                }},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    SoftForkDescPushBack(tip, softforks, consensusParams, Consensus::DEPLOYMENT_AUXPOW);
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    int blockcount = 30 * 24 * 60 * 60 / Params().GetConsensus().aux_pow_target_spacing; // By default: 1 month
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", "Average feerate (in kria per virtual byte)"},
                ...
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in kria per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", "Maximum feerate (in kria per virtual byte)"},
                ...
                {RPCResult::Type::NUM, "minfeerate", "Minimum feerate (in kria per virtual byte)"},
            ...
            RPCResult{"When action=='start'", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::ARR, "unspents", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_AMOUNT, "value", "The total amount in " + CURRENCY_UNIT + " of the unspent output time-adjusted to the next block height"},
