...
static std::string EntryDescriptionString()
{
    return "    \"vsize\" : n,            (numeric) virtual transaction size as defined in BIP 141. This is different from actual serialized size for witness transactions as witness data is discounted.\n"
           "    \"size\" : n,             (numeric) (DEPRECATED) same as vsize. Only returned if freicoind is started with -deprecatedrpc=size\n"
           "                              size will be completely removed in v20.\n"
...
UniValue gettxout(const JSONRPCRequest& request)
{
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in " + CURRENCY_UNIT + " at its reference height\n"
            "  \"refheight\" : n            (numeric) The reference height\n"
            "  \"amount\" : x.xxx,          (numeric) The transaction value in " + CURRENCY_UNIT + " as of the the next block\n"
            "  \"scriptPubKey\" : {         (json object)\n"
            "     \"asm\" : \"code\",       (string) \n"
            "     \"hex\" : \"hex\",        (string) \n"
            "     \"reqSigs\" : n,          (numeric) Number of required signatures\n"
            "     \"type\" : \"pubkeyhash\", (string) The type, eg pubkeyhash\n"
            "     \"addresses\" : [          (array of string) array of freicoin addresses\n"
...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    RPCHelpMan{"getblockstats",
            ...
            "  \"avgfeerate\": xxxxx,      (numeric) Average feerate (in kria per virtual byte)\n"
            "  \"avgtxsize\": xxxxx,       (numeric) Average transaction size\n"
            "  \"blockhash\": xxxxx,       (string) The block hash (to check for potential reorgs)\n"
            "  \"feerate_percentiles\": [  (array of numeric) Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in kria per virtual byte)\n"
            ...
            "  \"maxfeerate\": xxxxx,      (numeric) Maximum feerate (in kria per virtual byte)\n"
            "  \"maxtxsize\": xxxxx,       (numeric) Maximum transaction size\n"
            "  \"medianfee\": xxxxx,       (numeric) Truncated median fee in the block\n"
            "  \"mediantime\": xxxxx,      (numeric) The block median time past\n"
            "  \"mediantxsize\": xxxxx,    (numeric) Truncated median transaction size\n"
            "  \"minfee\": xxxxx,          (numeric) Minimum fee in the block\n"
            "  \"minfeerate\": xxxxx,      (numeric) Minimum feerate (in kria per virtual byte)\n"
...
UniValue scantxoutset(const JSONRPCRequest& request)
{
            ...
            "    \"refheight\": n,              (numeric) Reference height of the unspent transaction output\n"
            "    \"amount\": x.xxx,             (numeric) The total amount in " + CURRENCY_UNIT + " of the unspent output time-adjusted to the next block height\n"
            "   }\n"
            "   ,...],\n"
            "  \"total_amount\": x.xxx,          (numeric) The total amount of all found unspent outputs in " + CURRENCY_UNIT + " as of the next block\n"
            "]\n"
                },
                RPCExamples{""},
            }.Check(request);
