    ...
    return RPCHelpMan{"gettxoutsetinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_AMOUNT, "total_unspendable_value", "The total amount of coins permanently excluded from the UTXO set (only available if coinstatsindex is used)"},
