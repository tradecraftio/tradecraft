                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," Freicoin address if there is one"},
                                    }},
                                }},
                                ...
                                {RPCResult::Type::NUM, "witness_version", "The inner script version"},
...
UniValue finalizepst(const JSONRPCRequest& request)
{
            ...
            "                             extract and return the complete transaction in normal network serialization instead of the PST."},
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "pst", "The hex-encoded partially signed transaction if not extracted"},
...
UniValue analyzepst(const JSONRPCRequest& request)
{
            ...
            RPCResult {
                RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR_AMOUNT, "estimated_feerate", /* optional */ true, "Estimated feerate of the final signed transaction in " + CURRENCY_UNIT + "/kB. Shown only if all UTXO slots in the PST have been filled"},
