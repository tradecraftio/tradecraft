...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "createrawtransaction", 3, "lockheight" },
    ...
    { "walletcreatefundedpst", 0, "inputs" },
    { "walletcreatefundedpst", 1, "outputs" },
    { "walletcreatefundedpst", 2, "locktime" },
    { "walletcreatefundedpst", 3, "lockheight" },
    { "walletcreatefundedpst", 4, "options" },
    { "walletcreatefundedpst", 4, "add_inputs"},
    { "walletcreatefundedpst", 4, "include_unsafe"},
    { "walletcreatefundedpst", 4, "minconf"},
    { "walletcreatefundedpst", 4, "maxconf"},
    { "walletcreatefundedpst", 4, "changePosition"},
    { "walletcreatefundedpst", 4, "includeWatching"},
    { "walletcreatefundedpst", 4, "lockUnspents"},
    { "walletcreatefundedpst", 4, "fee_rate"},
    { "walletcreatefundedpst", 4, "feeRate"},
    { "walletcreatefundedpst", 4, "subtractFeeFromOutputs"},
    { "walletcreatefundedpst", 4, "conf_target"},
    { "walletcreatefundedpst", 4, "replaceable"},
    { "walletcreatefundedpst", 4, "solving_data"},
    { "walletcreatefundedpst", 4, "max_tx_weight"},
    { "walletcreatefundedpst", 5, "bip32derivs" },
    { "walletprocesspst", 1, "sign" },
    { "walletprocesspst", 3, "bip32derivs" },
    { "walletprocesspst", 4, "finalize" },
    { "descriptorprocesspst", 1, "descriptors"},
    { "descriptorprocesspst", 3, "bip32derivs" },
    { "descriptorprocesspst", 4, "finalize" },
    { "createpst", 0, "inputs" },
    { "createpst", 1, "outputs" },
    { "createpst", 2, "locktime" },
    { "createpst", 3, "lockheight" },
    { "createpst", 4, "replaceable" },
    { "combinepst", 0, "txs"},
    { "joinpsts", 0, "txs"},
    { "finalizepst", 1, "extract"},
    { "converttopst", 1, "permitsigdata"},
    { "converttopst", 2, "iswitness"},
    { "gettxout", 1, "n" },
    ...
    { "pstbumpfee", 1, "options" },
    { "pstbumpfee", 1, "conf_target"},
    { "pstbumpfee", 1, "fee_rate"},
    { "pstbumpfee", 1, "replaceable"},
    { "pstbumpfee", 1, "outputs"},
    { "pstbumpfee", 1, "original_change_index"},
    { "logging", 0, "include" },
    { "logging", 1, "exclude" },
    { "disconnectnode", 1, "nodeid" },
    { "upgradewallet", 0, "version" },
    { "addwitnessaddress", 2, "p2sh" },
