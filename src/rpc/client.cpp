...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "walletcreatefundedpst", 3, "options" },
    { "walletcreatefundedpst", 3, "add_inputs"},
    { "walletcreatefundedpst", 3, "include_unsafe"},
    { "walletcreatefundedpst", 3, "minconf"},
    { "walletcreatefundedpst", 3, "maxconf"},
    { "walletcreatefundedpst", 3, "changePosition"},
    { "walletcreatefundedpst", 3, "includeWatching"},
    { "walletcreatefundedpst", 3, "lockUnspents"},
    { "walletcreatefundedpst", 3, "fee_rate"},
    { "walletcreatefundedpst", 3, "feeRate"},
    { "walletcreatefundedpst", 3, "subtractFeeFromOutputs"},
    { "walletcreatefundedpst", 3, "conf_target"},
    { "walletcreatefundedpst", 3, "replaceable"},
    { "walletcreatefundedpst", 3, "solving_data"},
    { "walletcreatefundedpst", 3, "max_tx_weight"},
    { "walletcreatefundedpst", 4, "bip32derivs" },
