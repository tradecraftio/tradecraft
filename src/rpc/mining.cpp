...
UniValue getnetworkhashps(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 2)
        throw runtime_error(
            ...
            "\nnReturns the average network hashes per second as would be estimated if there was a difficulty adjustment in the next block, or as would have been calculated as of the block height specified.\n"
    ...
    LOCK(cs_main);
    return GetNetworkHashPS(params.size() > 0 ? params[0].get_int() : -1);
}
...
UniValue getblocktemplate(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    https://github.com/freicoin/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/freicoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/freicoin/bips/blob/master/bip-0145.mediawiki\n"
