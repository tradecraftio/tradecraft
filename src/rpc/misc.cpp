...
static RPCHelpMan createmultisig()
{
    return RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"address_type", RPCArg::Type::STR, /* default */ "legacy", "The address type to use. Options are \"legacy\" and \"bech32\"."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static RPCHelpMan createmerkleproof()
{
    return RPCHelpMan{"createmerkleproof",
        "\nCreate a fast Merkle-tree from the provided data elements, and return the proof structure and data necessary for validation.\n",
        {
            ...
            {"prehashed", RPCArg::Type::BOOL, /* default */ "false", "If set, the data elements specified are hex-encoded 256-bit hash values"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
    ...
    for (std::size_t i = 0; i < tree[0].m_verify.size(); ++i) {
        ...
        for (auto elem : data) {
            if (hash == elem.GetHash() && elem.m_data != boost::none) {
                obj.pushKV("data", HexStr(elem.m_data.get()));
                break;
            }
        }
