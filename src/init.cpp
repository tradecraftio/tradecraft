...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), "freicoin.conf"));
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "freicoind.pid"));
#endif
    ...
    strUsage += HelpMessageOpt("-port=<port>", strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 8639, 18639));
    ...
    if (showDebug)
        strUsage += HelpMessageOpt("-mintxfee=<amt>", strprintf("Fees (in FRC/Kb) smaller than this are considered zero fee for transaction creation (default: %s)",
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 8638, 18638));
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    try {
        ...
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Freicoin is probably already running.") + " %s.", strDataDir, e.what()));
    }
