...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    toolTip1 += tr("This means a fee of at least %1 per kB is required.").arg(FreicoinUnits::formatWithUnit(nDisplayUnit, CWallet::minTxFee.GetFeePerK())) + "<br /><br />";
    toolTip1 += tr("Can vary +/- 1 byte per input.");

    QString toolTip2 = tr("Transactions with higher priority are more likely to get included into a block.") + "<br /><br />";
    toolTip2 += tr("This label turns red if the priority is smaller than \"medium\".") + "<br /><br />";
    toolTip2 += tr("This means a fee of at least %1 per kB is required.").arg(FreicoinUnits::formatWithUnit(nDisplayUnit, CWallet::minTxFee.GetFeePerK()));

    QString toolTip3 = tr("This label turns red if any recipient receives an amount smaller than %1.").arg(FreicoinUnits::formatWithUnit(nDisplayUnit, ::minRelayTxFee.GetFee(546)));
