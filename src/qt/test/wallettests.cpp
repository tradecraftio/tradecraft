...
//
//     src/qt/test/test_freicoin-qt -platform xcb      # Linux
//     src/qt/test/test_freicoin-qt -platform windows  # Windows
...
void TestGUI()
{
    ...
    BumpFee(transactionView, txid1, false /* expect disabled */, {} /* expected error */, true /* cancel */);
    BumpFee(transactionView, txid1, false /* expect disabled */, {} /* expected error */, false /* cancel */);
    BumpFee(transactionView, txid1, true /* expect disabled */, "already bumped" /* expected error */, false /* cancel */);
    ...
    QString balanceComparison = FreicoinUnits::formatWithUnit(unit, balance, false, FreicoinUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: freicoin:")) != -1);
            QVERIFY(paymentTextList.at(2).indexOf(QString("Address:")) != -1);
            QCOMPARE(paymentTextList.at(3), QString("Amount: 0.000 000 01 ") + QString::fromStdString(CURRENCY_UNIT));
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'test_freicoin-qt -platform cocoa' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
