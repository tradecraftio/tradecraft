...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CFreicoinAddress& address, CAmount amount, bool rbf)
{
...
void TestSendCoins()
{
    ...
    uint256 txid1 = SendCoins(wallet, sendCoinsDialog, CFreicoinAddress(CKeyID()), 5 * COIN, false /* rbf */);
    uint256 txid2 = SendCoins(wallet, sendCoinsDialog, CFreicoinAddress(CKeyID()), 10 * COIN, true /* rbf */);
