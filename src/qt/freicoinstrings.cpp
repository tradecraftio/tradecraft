...
QT_TRANSLATE_NOOP("freicoin", "Error creating %s: You can't create non-HD wallets with this version."),
...
QT_TRANSLATE_NOOP("freicoin", "Send transactions with full-RBF opt-in enabled (RPC only, default: %u)"),
...
QT_TRANSLATE_NOOP("freicoin", "Wallet %s resides outside wallet directory %s"),
