...
QT_TRANSLATE_NOOP("freicoin", "Prune mode is incompatible with -coinstatsindex."),
...
QT_TRANSLATE_NOOP("freicoin", "Transaction needs a change address, but we can't generate it. %s"),
