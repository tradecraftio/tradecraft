...
QT_TRANSLATE_NOOP("freicoin-core", "(default: wallet.dat)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Freicoin Daemon"),
QT_TRANSLATE_NOOP("freicoin-core", "Freicoin RPC client version"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Clear list of wallet transactions (diagnostic tool; implies -rescan)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Connect to JSON-RPC on <port> (default: 8638 or testnet: 18638)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Disable safemode, override a real safe mode event (default: 0)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Error: system error: "),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to read block info"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to read block"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to sync block index"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write block index"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write block info"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write block"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write file info"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write to coin database"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write transaction index"),
QT_TRANSLATE_NOOP("freicoin-core", "Failed to write undo data"),
QT_TRANSLATE_NOOP("freicoin-core", "Fee per kB to add to transactions you send"),
QT_TRANSLATE_NOOP("freicoin-core", "Fees smaller than this are considered zero fee (for relaying) (default:"),
QT_TRANSLATE_NOOP("freicoin-core", "Find peers using DNS lookup (default: 1 unless -connect)"),
QT_TRANSLATE_NOOP("freicoin-core", "Force safe mode (default: 0)"),
QT_TRANSLATE_NOOP("freicoin-core", "Generate coins (default: 0)"),
QT_TRANSLATE_NOOP("freicoin-core", "Get help for a command"),
QT_TRANSLATE_NOOP("freicoin-core", "How many blocks to check at startup (default: 288, 0 = all)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Limit size of signature cache to <n> entries (default: 50000)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Log transaction priority and fee per kB when mining blocks (default: 0)"),
QT_TRANSLATE_NOOP("freicoin-core", "Maintain a full transaction index (default: 0)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Only accept block chain matching built-in checkpoints (default: 1)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Prepend debug output with timestamp (default: 1)"),
QT_TRANSLATE_NOOP("freicoin-core", "Print block on startup, if found in block index"),
QT_TRANSLATE_NOOP("freicoin-core", "Print block tree on startup (default: 0)"),
QT_TRANSLATE_NOOP("freicoin-core", "RPC SSL options: (see the Freicoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("freicoin-core", "RPC client options:"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Run a thread to flush wallet periodically (default: 1)"),
QT_TRANSLATE_NOOP("freicoin-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("freicoin-core", "SSL options: (see the Freicoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("freicoin-core", "Select SOCKS version for -proxy (4 or 5, default: 5)"),
QT_TRANSLATE_NOOP("freicoin-core", "Send command to Freicoin"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Set the number of threads to service RPC calls (default: 4)"),
QT_TRANSLATE_NOOP("freicoin-core", "Sets the DB_PRIVATE flag in the wallet db environment (default: 1)"),
QT_TRANSLATE_NOOP("freicoin-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("freicoin-core", "Show benchmark information (default: 0)"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Spend unconfirmed change when sending transactions (default: 1)"),
QT_TRANSLATE_NOOP("freicoin-core", "Start Freicoin Daemon"),
QT_TRANSLATE_NOOP("freicoin-core", "System error: "),
...
QT_TRANSLATE_NOOP("freicoin-core", "Usage (deprecated, use freicoin-cli):"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Wait for RPC server to start"),
...
QT_TRANSLATE_NOOP("freicoin-core", "version"),
