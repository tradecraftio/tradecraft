...
QT_TRANSLATE_NOOP("freicoin", "Error: Could not add watchonly tx to watchonly wallet"),
...
QT_TRANSLATE_NOOP("freicoin", "Error: Not all watchonly txs could be deleted"),
...
QT_TRANSLATE_NOOP("freicoin", "Unsupported global logging level -loglevel=%s. Valid values: %s."),
