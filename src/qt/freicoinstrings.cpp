...
QT_TRANSLATE_NOOP("freicoin", "Corrupt block found indicating potential hardware failure."),
...
QT_TRANSLATE_NOOP("freicoin", "Elliptic curve cryptography sanity check failure. %s is shutting down."),
...
QT_TRANSLATE_NOOP("freicoin", "Failed to connect best block (%s)."),
QT_TRANSLATE_NOOP("freicoin", "Failed to disconnect block."),
QT_TRANSLATE_NOOP("freicoin", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("freicoin", "Failed to read block."),
...
QT_TRANSLATE_NOOP("freicoin", "Failed to write block."),
QT_TRANSLATE_NOOP("freicoin", "Failed to write to block index database."),
QT_TRANSLATE_NOOP("freicoin", "Failed to write to coin database."),
QT_TRANSLATE_NOOP("freicoin", "Failed to write undo data."),
...
QT_TRANSLATE_NOOP("freicoin", "Only direction was set, no permissions: '%s'"),
...
QT_TRANSLATE_NOOP("freicoin", "Signer did not echo address"),
QT_TRANSLATE_NOOP("freicoin", "Signer echoed unexpected address %s"),
QT_TRANSLATE_NOOP("freicoin", "Signer returned error: %s"),
...
QT_TRANSLATE_NOOP("freicoin", "System error while flushing: %s"),
QT_TRANSLATE_NOOP("freicoin", "System error while loading external block file: %s"),
QT_TRANSLATE_NOOP("freicoin", "System error while saving block to disk: %s"),
...
QT_TRANSLATE_NOOP("freicoin", "There is no ScriptPubKeyManager for this address"),
...
QT_TRANSLATE_NOOP("freicoin", "Unrecognised option \"%s\" provided in -test=<option>."),
