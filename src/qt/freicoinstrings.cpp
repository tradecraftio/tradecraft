...
QT_TRANSLATE_NOOP("freicoin", "No proxy server specified. Use -proxy=<ip> or -proxy=<ip:port>."),
...
QT_TRANSLATE_NOOP("freicoin", "SQLiteDatabase: Failed to fetch sqlite wallet schema version: %s"),
QT_TRANSLATE_NOOP("freicoin", "SQLiteDatabase: Failed to fetch the application id: %s"),
