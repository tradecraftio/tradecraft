...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    if (model->wallet().privateKeysDisabled()) {
        ...
        bool complete = false;
        const TransactionError err = model->wallet().fillPST(SIGHASH_ALL, false /* sign */, true /* bip32derivs */, pstx, complete, nullptr);
        assert(!complete);
        ...
        case QMessageBox::Save: {
            ...
            QString filename = GUIUtil::getSaveFileName(this,
                ...
                tr("Partially Signed Transaction (Binary) (*.pst)"), &selectedFilter);
            if (filename.isEmpty()) {
                return;
            }
