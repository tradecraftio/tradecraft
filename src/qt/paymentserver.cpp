...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("freicoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'freicoin://' is not a valid URI. Use 'freicoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(FREICOIN_IPC_PREFIX, Qt::CaseInsensitive)) // freicoin: URI
    {
