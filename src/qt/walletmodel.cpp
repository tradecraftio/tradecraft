...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    try {
        ...
        const auto& res = m_wallet->createTransaction(vecSend, /*refheight=*/-1, coinControl, /*sign=*/!wallet().privateKeysDisabled(), nChangePosRet, nFeeRequired);
...
bool WalletModel::bumpFee(uint256 hash, uint256& new_hash)
{
    ...
    if (retval == QMessageBox::Save) {
        ...
        bool complete = false;
        const TransactionError err = wallet().fillPST(SIGHASH_ALL, /*sign=*/false, /*bip32derivs=*/true, nullptr, pstx, complete);
        ...
        Q_EMIT message(tr("PST copied"), tr("Copied to clipboard", "Fee-bump PST saved"), CClientUIInterface::MSG_INFORMATION);
        return true;
    }
