...
public:
    ...
    void setDisplayUnit(int unit)
    {
        ...
        currentUnit = unit;
        lineEdit()->setPlaceholderText(FreicoinUnits::format(currentUnit, m_min_amount, false, FreicoinUnits::separatorAlways));
        if(valid)
            setValue(val);
        else
            clear();
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, FreicoinUnits::format(FreicoinUnits::FRC, FreicoinUnits::maxMoney(), false, FreicoinUnits::separatorAlways));
...
private:
    int currentUnit{FreicoinUnits::FRC};
    ...
    amount(nullptr)
{
    ...
    connect(unit, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &FreicoinAmountField::unitChanged);
