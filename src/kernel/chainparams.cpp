...
public:
    explicit CMainParams(const CChainParams::MainNetOptions& opts) {
        ...
        hw << tag;
        hw << tag;
        hw << BLK_NO_AUXPOW_NOR_WITNESS(genesis);
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 2688 0000000003785caa54529380bbf22211bd32b6539485896c61c69d23668f5c1b
            .nTime    = 1708786404,
            .nTxCount = 1206329,
            .dTxRate  = 0.002140245026084857,
        };
    }
};
