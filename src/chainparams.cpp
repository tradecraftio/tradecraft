...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData) {
            ...
            1613065771, // * UNIX timestamp of last checkpoint block
            1004030,    // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            194.67      // * estimated number of transactions per day after checkpoint
        };
    }
};
