...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.freicoin.dashjr.org", false); // Luke Dashjr
        vSeeds.emplace_back("seed.freicoinstats.com", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.freicoin.jonasschnelli.ch", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.frc.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.freicoin.jonasschnelli.ch", true);
        vSeeds.emplace_back("seed.tfrc.petertodd.org", true);
