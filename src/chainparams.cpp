...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            // Data as of block 0x58c121907bf5f005acdddf38da413fcd2c9f7048163bcfa0310fa7bd067b7e44 (height 25259)
            1729644118,
            48908,
...
{
    assert(pCurrentParams);
    pCurrentParams->consensus.vDeployments[d].nStartTime = nStartTime;
    pCurrentParams->consensus.vDeployments[d].nTimeout = nTimeout;
}
