...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            // Data as of block ea767ef6150a2fe2c1d3be59464db199adb14e9197e8277acf2db68fe9896eec (height 424780).
            1729071811, // * UNIX timestamp of last known number of transactions
            1249564,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.001680734703331907 // * estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000001d134f91d559fc28fb");
        ...
        chainTxData = ChainTxData{
            // Data as of block 58c121907bf5f005acdddf38da413fcd2c9f7048163bcfa0310fa7bd067b7e44 (height 25259)
            1729644118,
            48908,
            0.002227688309277393
        };
...
public:
    CRegTestParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_LOCKTIME].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_FINALTX].bit = 1;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_AUXPOW].nTimeout = 0; // disable
