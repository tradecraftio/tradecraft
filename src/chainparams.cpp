...
public:
    explicit CMainParams(const ArgsManager& args) {
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 322560 0000000000000c6e3b938bc8dddf6c05a8ce4b4d46af273d4af4bea53c23ea84
            /* nTime    */ 1632922391,
            /* nTxCount */ 1044463,
            /* dTxRate  */ 0.002008547438911023
        };
...
public:
    explicit CTestNetParams(const ArgsManager& args) {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000000000b5f8d7a875bd74");
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 2016 0x00000000000017c5d079dfbe901cb7d0fae2a8eafd91be4e98f23481c73921d5
            /* nTime    */ 1596962899,
            /* nTxCount */ 2422,
            /* dTxRate  */ 0.002253125
        };
