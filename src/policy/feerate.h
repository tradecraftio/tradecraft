...
public:
    ...
    friend CFeeRate operator*(const CFeeRate& f, int a) { return CFeeRate(a * f.nKriaPerK); }
    friend CFeeRate operator*(int a, const CFeeRate& f) { return CFeeRate(a * f.nKriaPerK); }
