Contributing to Freicoin
============================

The Freicoin project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Freicoin
...
Before you start contributing, familiarize yourself with the Freicoin build
system and tests. Refer to the documentation in the repository on how to build
Freicoin and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/tradecraftio/tradecraft/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/tradecraftio/tradecraft/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
`#freicoin` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#freicoin). Chat
history logs can be found
on [https://www.erisian.com.au/freicoin-dev/](https://www.erisian.com.au/freicoin-dev/)
and [https://gnusha.org/freicoin-dev/](https://gnusha.org/freicoin-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/freicoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/freicoindev/](https://gnusha.org/pi/freicoindev/).
...
For GUI-related issues or pull requests, the https://github.com/freicoin/gui repository should be used.
For all other issues and pull requests, the https://github.com/tradecraftio/tradecraft node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to freicoin-qt
...
fork of Freicoin copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/tradecraftio/tradecraft/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/tradecraftio/tradecraft  # Fetch the latest upstream commit
...
The following applies to code changes to the Freicoin project (and related
projects such as libsecp256k1), and is not to be confused with overall Freicoin
Network Protocol consensus changes.

Whether a pull request is merged into Freicoin rests with the project merge
maintainers.
...
Patches that change Freicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Freicoin consensus, it must have been
...
https://github.com/tradecraftio/tradecraft-maintainer-tools#backport).

Copyright
---------

By contributing to this repository, you agree to license your work under the
GNU Affero General Public License v3.0 unless specified otherwise in
`contrib/debian/copyright` or at the top of the file itself. Any work
