...
// freicoin includes.
#include <..\src\script\freicoinconsensus.h>
...
int main()
{
    std::cout << "freicoinconsensus version: " << freicoinconsensus_version() << std::endl;
    ...
    auto op0Result = freicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, freicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
